...
* **Diferenciación Canónica entre `code` e `indexCode`, Orden Temario Canónico y Crecimiento Dinámico del Canon (v7.2 / v7.19 / v7.19.1 / v7.30):**
  ...
  * **Rangos Base y Protocolo de Crecimiento del Canon (v7.30, PROMPT 024):**
    ...
    * **Civil (`CANON_CIVIL`, base 34 tópicos):** `1.1` a `1.M` (`1.34` base) siguiendo la dogmática canónica:
      ...
      * Nuevos apuntes civiles (ej. Sucesiones, Familia) se intercalan según su orden en `TEMARIO_CANONICO['civil']` expandiendo la secuencia `1.1..1.M` de forma continua y sin huecos.
