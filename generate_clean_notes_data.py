...
FILES_CONFIG = [
    ...
    {
        "file": "CONTRATOARRENDAMIENTO-pulido.md",
        "subject": "civil",
        "discipline": "I. Derecho Civil",
        "defaultCategory": "Contrato de Arrendamiento",
        "defaultChapterNum": 12,
        "categoryMap": {
            "1.1": ("Contrato de Arrendamiento", 12),
            "1.2": ("Contrato de Arrendamiento", 12),
            "1.3": ("Contrato de Arrendamiento", 12),
            "1.4": ("Contrato de Arrendamiento", 12),
            "1.5": ("Contrato de Arrendamiento", 12)
        }
    },
    {
        "file": "CONTRATOCOMODATO-pulido.md",
        "subject": "civil",
        "discipline": "I. Derecho Civil",
        "defaultCategory": "Contrato de Comodato",
        "defaultChapterNum": 13,
        "categoryMap": {
            "1.1": ("Contrato de Comodato", 13),
            "1.2": ("Contrato de Comodato", 13),
            "1.3": ("Contrato de Comodato", 13),
            "1.4": ("Contrato de Comodato", 13),
            "1.5": ("Contrato de Comodato", 13),
            "1.6": ("Contrato de Comodato", 13),
            "1.7": ("Contrato de Comodato", 13),
            "2.1": ("Contrato de Comodato", 13),
            "2.2": ("Contrato de Comodato", 13),
            "2.3": ("Contrato de Comodato", 13),
            "2.4": ("Contrato de Comodato", 13),
            "2.5": ("Contrato de Comodato", 13),
            "2.6": ("Contrato de Comodato", 13),
            "2.7": ("Contrato de Comodato", 13),
            "3.1": ("Contrato de Comodato", 13),
            "3.2": ("Contrato de Comodato", 13),
            "3.3": ("Contrato de Comodato", 13),
            "3.4": ("Contrato de Comodato", 13),
            "3.5": ("Contrato de Comodato", 13),
            "3.6": ("Contrato de Comodato", 13),
            "3.7": ("Contrato de Comodato", 13),
            "3.8": ("Contrato de Comodato", 13),
            "4.1": ("Contrato de Comodato", 13),
            "4.2": ("Contrato de Comodato", 13),
            "4.3": ("Contrato de Comodato", 13),
            "4.4": ("Contrato de Comodato", 13),
            "4.5": ("Contrato de Comodato", 13)
        }
    },
    {
        "file": "CONTRATOMUTUO-pulido.md",
        "subject": "civil",
        "discipline": "I. Derecho Civil",
        "defaultCategory": "Contrato de Mutuo",
        "defaultChapterNum": 14,
        "categoryMap": {
            "1.1": ("Contrato de Mutuo", 14),
            "1.2": ("Contrato de Mutuo", 14),
            "1.3": ("Contrato de Mutuo", 14),
            "1.4": ("Contrato de Mutuo", 14),
            "2.1": ("Contrato de Mutuo", 14),
            "2.2": ("Contrato de Mutuo", 14),
            "2.3": ("Contrato de Mutuo", 14),
            "2.4": ("Contrato de Mutuo", 14),
            "2.5": ("Contrato de Mutuo", 14),
            "3.1": ("Contrato de Mutuo", 14),
            "3.2": ("Contrato de Mutuo", 14),
            "3.3": ("Contrato de Mutuo", 14),
            "3.4": ("Contrato de Mutuo", 14),
            "3.5": ("Contrato de Mutuo", 14),
            "3.6": ("Contrato de Mutuo", 14),
            "3.7": ("Contrato de Mutuo", 14),
            "3.8": ("Contrato de Mutuo", 14),
            "3.9": ("Contrato de Mutuo", 14),
            "3.10": ("Contrato de Mutuo", 14),
            "4.1": ("Contrato de Mutuo", 14),
            "4.2": ("Contrato de Mutuo", 14),
            "4.3": ("Contrato de Mutuo", 14),
            "4.4": ("Contrato de Mutuo", 14),
            "4.5": ("Contrato de Mutuo", 14)
        }
    },
    {
        "file": "CONTRATOMANDATO-pulido.md",
        "subject": "civil",
        "discipline": "I. Derecho Civil",
        "defaultCategory": "Contrato de Mandato",
        "defaultChapterNum": 15,
        "categoryMap": {
            "1.1": ("Contrato de Mandato", 15),
            "1.2": ("Contrato de Mandato", 15),
            "1.3": ("Contrato de Mandato", 15),
            "1.4": ("Contrato de Mandato", 15),
            "1.5": ("Contrato de Mandato", 15),
            "1.6": ("Contrato de Mandato", 15),
            "2.1": ("Contrato de Mandato", 15),
            "2.2": ("Contrato de Mandato", 15),
            "2.3": ("Contrato de Mandato", 15),
            "2.4": ("Contrato de Mandato", 15),
            "2.5": ("Contrato de Mandato", 15),
            "3.1": ("Contrato de Mandato", 15),
            "3.2": ("Contrato de Mandato", 15),
            "3.3": ("Contrato de Mandato", 15),
            "3.4": ("Contrato de Mandato", 15),
            "3.5": ("Contrato de Mandato", 15),
            "3.6": ("Contrato de Mandato", 15),
            "3.7": ("Contrato de Mandato", 15),
            "4.1": ("Contrato de Mandato", 15),
            "4.2": ("Contrato de Mandato", 15),
            "4.3": ("Contrato de Mandato", 15),
            "5.1": ("Contrato de Mandato", 15),
            "5.2": ("Contrato de Mandato", 15),
            "5.3": ("Contrato de Mandato", 15),
            "5.4": ("Contrato de Mandato", 15),
            "5.5": ("Contrato de Mandato", 15),
            "5.6": ("Contrato de Mandato", 15),
            "5.7": ("Contrato de Mandato", 15)
        }
    },
    {
        "file": "CONTRATOHIPOTECA-pulido.md",
        "subject": "civil",
        "discipline": "I. Derecho Civil",
        "defaultCategory": "Derechos Reales de Garantía",
        "defaultChapterNum": 11,
        "categoryMap": {
            "1.1": ("Derechos Reales de Garantía", 11),
            "1.2": ("Derechos Reales de Garantía", 11),
            "1.3": ("Derechos Reales de Garantía", 11),
            "1.4": ("Derechos Reales de Garantía", 11),
            "2.1": ("Derechos Reales de Garantía", 11),
            "2.2": ("Derechos Reales de Garantía", 11),
            "2.3": ("Derechos Reales de Garantía", 11),
            "2.4": ("Derechos Reales de Garantía", 11),
            "2.5": ("Derechos Reales de Garantía", 11),
            "3.1": ("Derechos Reales de Garantía", 11),
            "3.2": ("Derechos Reales de Garantía", 11),
            "3.3": ("Derechos Reales de Garantía", 11),
            "3.4": ("Derechos Reales de Garantía", 11),
            "4.1": ("Derechos Reales de Garantía", 11),
            "4.2": ("Derechos Reales de Garantía", 11),
            "4.3": ("Derechos Reales de Garantía", 11),
            "4.4": ("Derechos Reales de Garantía", 11),
            "4.5": ("Derechos Reales de Garantía", 11)
        }
    }
]
...
TEMARIO_CANONICO = {
    "civil": [
        ...
        (9,  12, ["arrendamiento", "arrendador", "arrendatario", "renta", "subarrendamiento", "18.101", "confeccion de obra", "desahucio"], "Contrato de Arrendamiento"),
        (10, 13, ["comodato", "comodatario", "comodante", "precario", "prestamo de uso"], "Contrato de Comodato"),
        (11, 14, ["mutuo", "mutuante", "mutuario", "credito de dinero", "interes", "reajuste", "anatocismo", "2208"], "Contrato de Mutuo"),
        (12, 15, ["mandato", "mandante", "mandatario", "representacion", "delegacion", "rendir cuenta", "autocontratacion", "2138", "2158"], "Contrato de Mandato"),
        (13, 9, ["sucesiones", "herencia", "testamento", "legitima", "particion", "sucesion", "intestada", "forzosa"], "Derecho de Sucesiones"),
        (14, 10, ["familia", "matrimonio", "filiacion", "alimentos", "regimen patrimonial", "divorcio", "sociedad conyugal", "bienes reservados"], "Derecho de Familia"),
        (15, 11, ["garantias", "hipoteca", "prenda", "fianza", "caucion", "reales de garantia"], "Derechos Reales de Garantía"),
    ],
    "procesal": [
